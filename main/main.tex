...
\caption[Sequence of aggregation of REST resources]{\textbf{Sequence diagram showing the aggregation of low-level
...
\caption[Revised REST aggregation sequence of a streaming client]{\textbf{Revised aggregation sequence showing a client which
