...
separately from other HTTP requests. Schneier argues that ``complexity
is the worst enemy of security'' (Schneier 2000 Software Complexity and
Security) and in one online debate paints a buildings analogy (Schneier
2013):
...
---------. 2013. ``To Profile or Not to Profile? - a Debate Between Sam
Harris and Bruce Schneier.''
